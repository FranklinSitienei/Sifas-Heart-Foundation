    ...
    useEffect(() => {
        const checkAuth = async () => {
            ...
            try {
                ...
                const profileResponse = await fetch('https://sifas-heart-foundation.onrender.com/api/auth/profile', {
                    headers: {
                ...
                if (profileResponse.ok) {
                    ...
                    const leaderboardResponse = await fetch(`https://sifas-heart-foundation.onrender.com/api/leaderboards/monthly?year=${currentYear}&timezone=${timezone}`);
