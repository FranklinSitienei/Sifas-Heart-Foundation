...
const Donations = () => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      try {
        const response = await fetch('https://sifas-heart-foundation-2.onrender.com/api/auth/profile', {
          headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const updateResponse = await fetch('https://sifas-heart-foundation-2.onrender.com/api/auth/update_mobile', {
        method: 'PUT',
        headers: {
      ...
      if (donation.paymentMethod === 'M-Pesa') {
        ...
        response = await fetch('https://sifas-heart-foundation-2.onrender.com/api/lipa/stk', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
        ...
        if (response.ok) {
          ...
          const checkDonationStatus = async () => {
            const statusResponse = await fetch(`https://sifas-heart-foundation-2.onrender.com/api/donations/status/${data.CheckoutRequestID}`, {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            });
        ...
        response = await fetch('https://sifas-heart-foundation-2.onrender.com/api/donations/donate', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
