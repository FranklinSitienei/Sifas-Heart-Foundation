...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://sifas-heart-foundation.onrender.com/api/admin/signup', {
                method: 'POST',
                headers: {
    ...
    const handleGoogleSignUp = () => {
        ...
        window.open('https://sifas-heart-foundation.onrender.com/admin/auth/google', '_self');
    };
    ...
    const handlePasswordModalSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://sifas-heart-foundation.onrender.com/api/admin/password-setup', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
